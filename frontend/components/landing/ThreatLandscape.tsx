...
export default function ThreatLandscape() {
  return (
    <section id="threat" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 border-b border-[var(--border-main)] transition-colors duration-300">
      ...
      <div className="max-w-3xl mb-16">
        ...
        <h2 className="text-3xl sm:text-5xl font-black text-slate-900 dark:text-white tracking-tight mb-6 leading-tight">
          ...
          <span className="text-slate-500 dark:text-slate-400">The pattern isn't.</span>
        </h2>
        <p className="text-slate-800 dark:text-slate-200 text-base sm:text-lg leading-relaxed font-sans mb-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        ...
        <div className="glass-panel p-8 rounded-2xl flex flex-col justify-between relative overflow-hidden group">
          <div className="absolute top-0 right-0 w-32 h-32 bg-indigo-500/10 dark:bg-slate-800/10 rounded-full blur-2xl group-hover:bg-indigo-500/20 dark:group-hover:bg-slate-700/20 transition-all" />
          <div>
        ...
        <div className="glass-panel p-8 rounded-2xl flex flex-col justify-between relative overflow-hidden group border-t-2 border-t-amber-500">
          <div className="absolute top-0 right-0 w-32 h-32 bg-amber-500/10 dark:bg-amber-500/5 rounded-full blur-2xl group-hover:bg-amber-500/20 dark:group-hover:bg-amber-500/10 transition-all" />
          <div>
            <div className="flex items-center justify-between text-[11px] font-mono uppercase tracking-wider text-amber-600 dark:text-amber-400/90 mb-4">
              <span className="flex items-center gap-1.5 font-bold">
                <TrendingUp className="w-3.5 h-3.5" />
                THE IMPORTANT CAVEAT
              </span>
              <span className="text-slate-500 dark:text-slate-400 font-mono font-bold">SIGNAL RATIO</span>
            </div>
          ...
          <div className="pt-6 mt-6 border-t border-[var(--border-subtle)] flex items-center justify-between text-[11px] font-mono text-amber-700 dark:text-amber-400/80">
        ...
        <div className="glass-panel p-8 rounded-2xl flex flex-col justify-between relative overflow-hidden group border-t-2 border-t-rose-500">
          <div className="absolute top-0 right-0 w-32 h-32 bg-rose-500/10 dark:bg-rose-500/5 rounded-full blur-2xl group-hover:bg-rose-500/20 dark:group-hover:bg-rose-500/10 transition-all" />
          <div>
            <div className="flex items-center justify-between text-[11px] font-mono uppercase tracking-wider text-rose-600 dark:text-rose-400/90 mb-4">
              <span className="flex items-center gap-1.5 font-bold">
                <Landmark className="w-3.5 h-3.5" />
                INDIA ENFORCEMENT REALITY
              </span>
              <span className="text-slate-500 dark:text-slate-400 font-mono font-bold">ED CASEFILE</span>
            </div>
          ...
          <div className="pt-6 mt-6 border-t border-[var(--border-subtle)] flex items-center justify-between text-[11px] font-mono text-rose-700 dark:text-rose-400/80">
      ...
      <div className="glass-panel p-6 sm:p-8 rounded-2xl bg-[var(--bg-surface)] border border-[var(--border-main)]">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-center">
          ...
          <div className="lg:col-span-2 space-y-3">
            <div className="flex items-center space-x-2 text-xs font-mono uppercase tracking-wider text-slate-500 dark:text-slate-400 font-bold">
            ...
            <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-400 leading-relaxed font-sans">
          ...
          <div className="bg-[var(--bg-card)] p-5 rounded-xl border border-[var(--border-main)] font-mono text-xs space-y-2.5 shadow-xs">
            <div className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-widest border-b border-[var(--border-subtle)] pb-1 font-bold">
              STATUTORY ALIGNMENT
            </div>
            <div className="flex justify-between text-slate-700 dark:text-slate-300">
              <span className="text-slate-500 dark:text-slate-400 font-semibold">Regulator:</span>
              <span className="font-bold text-slate-900 dark:text-white">FIU-India</span>
            </div>
            <div className="flex justify-between text-slate-700 dark:text-slate-300">
              <span className="text-slate-500 dark:text-slate-400 font-semibold">Framework:</span>
              <span className="font-bold text-slate-900 dark:text-white">PMLA / VDA Guidelines</span>
            </div>
            <div className="flex justify-between text-slate-700 dark:text-slate-300">
              <span className="text-slate-500 dark:text-slate-400 font-semibold">Forensics:</span>
              <span className="text-emerald-600 dark:text-emerald-400 font-bold">Corroborated Offline</span>
            </div>
          </div>
