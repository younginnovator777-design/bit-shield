...
export default function CapabilitiesSection() {
  ...
  return (
    <section id="capabilities" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 border-b border-slate-900">
      ...
      <div className="max-w-3xl mb-16">
        ...
        <h2 className="text-3xl sm:text-5xl font-black text-white tracking-tight mb-6 leading-tight">
          ...
          <span className="text-slate-300">investigative picture.</span>
        </h2>
        ...
        {capabilities.map((cap, idx) => (
          <div
            ...
            className={`glass-panel p-8 rounded-2xl flex flex-col justify-between border transition-all duration-300 relative group cursor-pointer ${
              activeTab === idx
                ? "bg-slate-900/90 border-slate-600 shadow-[0_15px_35px_rgba(0,0,0,0.8)]"
          ...
          >
            <div>
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-sm font-mono font-black text-white px-2.5 py-0.5 rounded bg-slate-800 border border-slate-700/80">
                  {cap.title}
                </span>
              </div>
            ...
            <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/80 font-mono text-xs">
              {cap.visualType === "connect" && (
                <div className="space-y-2">
                  <div className="flex justify-between text-[11px] text-slate-400 border-b border-slate-900 pb-1.5">
                    <span>EVIDENTIARY CONVERGENCE</span>
                    <span className="text-slate-400">GRAPH RESOLVED</span>
                  </div>
                  <div className="grid grid-cols-3 gap-2 text-center text-[10px]">
                    <div className="p-2 bg-slate-900/80 rounded border border-slate-800">
                      <div className="text-slate-400">TX Records</div>
                      <div className="font-bold text-white mt-0.5">38,420</div>
                    </div>
                    <div className="p-2 bg-slate-900/80 rounded border border-slate-800">
                      <div className="text-slate-400">IP/ASN Pairs</div>
                      <div className="font-bold text-white mt-0.5">1,248</div>
                    </div>
                    <div className="p-2 bg-slate-900/80 rounded border border-slate-800">
                      <div className="text-slate-400">CIOH Entities</div>
                      <div className="font-bold text-slate-300 mt-0.5">312</div>
                    </div>
                  </div>
                </div>
              )}
              ...
              {cap.visualType === "detect" && (
                <div className="space-y-2">
                  <div className="flex justify-between text-[11px] text-slate-400 border-b border-slate-900 pb-1.5">
                    ...
                    <span className="text-rose-400 font-bold">OUTLIER ISOLATED</span>
                  </div>
                  <div className="flex items-center space-x-3 text-[11px]">
                    <div className="flex-1 bg-slate-900 h-3 rounded-full overflow-hidden flex">
                      <div className="w-4/5 bg-slate-700/60" title="Normal baseline (99%)"></div>
                      <div className="w-1/5 bg-rose-500" title="Anomalous outlier (<1%)"></div>
                    </div>
                    <span className="text-rose-400 font-bold font-mono">0.897</span>
                  </div>
                </div>
              )}
              ...
              {cap.visualType === "explain" && (
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-[11px]">
                    <div className="flex justify-between p-1.5 bg-slate-900/80 rounded border border-rose-900/40 text-rose-300">
                    ...
                    <div className="flex justify-between p-1.5 bg-slate-900/80 rounded border border-amber-900/40 text-amber-300">
                      <span>GRAPH ANOMALY</span>
                      <span className="font-bold">+21</span>
                    </div>
                    <div className="flex justify-between p-1.5 bg-slate-900/80 rounded border border-slate-700/60 text-slate-300">
              ...
              {cap.visualType === "investigate" && (
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-1.5 text-[10px]">
                    <span className="bg-slate-900 text-slate-300 px-2 py-1 rounded border border-slate-800">
                      Expand 2-Hop Graph
                    </span>
                    <span className="bg-slate-900 text-slate-300 px-2 py-1 rounded border border-slate-800">
                      Filter ASN Clusters
