...
export default function ActivityTicker() {
  ...
  return (
    <div className="ws-card overflow-hidden py-2.5 px-4 flex items-center gap-3">
      <span className="text-[9px] font-mono font-bold text-slate-400 uppercase tracking-widest shrink-0 border-r border-slate-800 pr-3 mr-1">
        LIVE FEED
      </span>
      <div className="overflow-hidden flex-1 relative">
        <div className="animate-ticker flex gap-8">
          {events.map((e, i) => (
            <span key={i} className="text-[11px] font-mono text-slate-300 shrink-0 flex items-center gap-2">
